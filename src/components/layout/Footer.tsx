            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/career-paths" className="text-base text-gray-500 hover:text-gray-900">
                      Career Paths
                    </Link>
                  </li>
                  <li>
                    <Link to="/skills" className="text-base text-gray-500 hover:text-gray-900">
                      Skills Assessment
                    </Link>
                  </li>
                  <li>
                    <Link to="/insights" className="text-base text-gray-500 hover:text-gray-900">
                      Market Insights
                    </Link>
                  </li>
                </ul>
